...
namespace R8.RedisMapper
{
    ...
    {
        // private static readonly Dictionary<Type, CachedPropertyInfo[]> CachedTypes = new Dictionary<Type, CachedPropertyInfo[]>();
        //
        ...
        //     CachedTypes.Add(type, memory.ToArray());
        //
        //     if (propertyNames.Count > 0)
        //     {
        //         Memory<CachedPropertyInfo> filteredArray = new CachedPropertyInfo[propertyNames.Count];
        ...
        //     {
        //         var cachedProps = (CachedPropertyInfo[])CachedTypes[type];
        ...
        public static bool SetValue<TModel>(this CachedPropertyInfo property, TModel container, RedisValue value, IEnumerable<IRedisValueSerializer> formatters, RedisValueReaderContext readerContext)
        {
            ...
            // if (formatter != null)
            // {
            //     object obj = formatter switch
            //     {
            //         RedisValueFormatterInternal valueFormatter => valueFormatter.ReadCore(value, readerContext),
            //         // RedisObjectFormatterInternal objectFormatter => objectFormatter.ReadClass<T>(value, readerContext),
            //         _ => throw new NotSupportedException($"Formatter of type {formatter.GetType()} is not supported.")
            //     };
        ...
        public static RedisValue GetValue<TModel>(this CachedPropertyInfo property, TModel container, IList<IRedisValueSerializer> valueFormatters, RedisValueWriterContext writerContext)
        {
