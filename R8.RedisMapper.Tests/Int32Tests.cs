...
//         public void should_return_value_with_formatter(int? value, bool ignoreDefaultValue, bool nullExpected)
//         {
//             var writerContext = new RedisValueWriterContext { IgnoreDefaultValue = ignoreDefaultValue };
//             var valueType = typeof(int);
//             var context = new RedisValueWriterContext(writerContext, valueType);
//             var formatter = new Int32ValueFormatter();
...
//                 rv.TryParse(out int i).Should().BeTrue();
//                 i.Should().Be(p);
//             }
//             
